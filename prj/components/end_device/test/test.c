...
uint8_t app_key[APP_KEY_SIZE] = {0xb6, 0xd5, 0xc0, 0x0a, 0xd6, 0xfa, 0x96, 0x4d, 0x4b, 0xa9, 0xa0, 0x16, 0x52, 0x64, 0x7b, 0x93};;
uint8_t dev_eui[DEV_EUI_SIZE] = {0xFE, 0xFF, 0xFF, 0x00, 0x00, 0x0B, 0xBB, 0xBB};
#endif
